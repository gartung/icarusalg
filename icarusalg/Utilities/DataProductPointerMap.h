/**
 * @file   icarusalg/Utilities/DataProductPointerMap.h
...
#ifndef icarusalg_UTILITIES_DATAPRODUCTPOINTERMAP_H
#define icarusalg_UTILITIES_DATAPRODUCTPOINTERMAP_H
...
#endif // icarusalg_UTILITIES_DATAPRODUCTPOINTERMAP_H
